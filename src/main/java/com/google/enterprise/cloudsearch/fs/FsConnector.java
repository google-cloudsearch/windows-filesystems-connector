...
/** Connector for indexing content stored in Windows shares using Google Cloud Search. */
public class FsConnector {
  public static void main(String[] args) throws InterruptedException {
    IndexingApplication application =
        new IndexingApplication.Builder(new ListingConnector(new FsRepository()), args).build();
    application.start();
  }
}
